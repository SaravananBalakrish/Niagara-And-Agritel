...
class AuthRepositoryImpl implements AuthRepository {
  ...
  @override
  Future<Either<Failure, UserEntity>> verifyOtp(String verificationId, String otp, String phone) async {
    try {
      final user = await remote.verifyOtp(verificationId, otp, phone);
      await local.cacheUser(user);
      return Right(user);
    } on AuthException catch (e) {
      return Left(AuthFailure(code: e.statusCode, message: e.message));
